package vn.com.nimbus.blog.api;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;
import org.springframework.context.annotation.ComponentScan;
import vn.com.nimbus.blog.api.config.ApiPublicConfigLoader;
...
public class BlogPublicApplication extends BaseApplication {
    ...
    private static void loadApiConfig(String env) {
        ...
        ApiPublicConfigLoader.getInstance().initializeConfigLoader(inputStreamConfig);
